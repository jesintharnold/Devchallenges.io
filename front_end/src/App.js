...
function App() {
  ...
  return (
    ...
    <div className="z-20 lg:flex flex-col h-[90%]">
     ...
     {/* Channels Here */}
     <Channels setChannel={setChannel} set={setgetChannels} get={getChannels}/>
    </div>

    <Channeloverview channel={channel} setChannel={setChannel}/>
   {/* Logout options */}
 ...
 <div className="h-full relative bg-main text-white z-10  lg:flex-1">
     {/* Chats */}
    <Chat channel={channel} setSide={setSide} side={side}/>
 </div>
