...
function App() {
  ...
  return (
    ...
    <div className={"fixed left-0 top-0  flex flex-col z-50 min-h-full w-[16rem] lg:relative bg-side text-white  lg:w-72   transition duration-200 ease-in-out lg:translate-x-0 "+(side?'':'-translate-x-full')}>
    ...
    <div className="z-20">
     ...
     <div>  
       <span onClick={()=>setChannel({...channel,checked:!channel.checked})}>WELCOME</span>     
     </div>
    </div>
    ...
    <div className={"absolute z-30 -translate-x-full transition duration-200 ease-in-out bg-side "+(channel.checked?'-translate-x-0':'')}>
    ...
    <div className="h-auto px-4 py-2 my-2">
