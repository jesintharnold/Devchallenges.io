...
export const Main=()=>{
    return (
        ...
        <Link className='float-right font-semibold hidden md:block text-lg opacity-70'>SEE MORE &#8594;</Link>
        </div>
        ...
        <Link className='font-semibold block text-base opacity-70 w-auto'>READ MORE &#8594;</Link>
        </div>
